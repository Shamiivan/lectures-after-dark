...
### Phase 1: Foundation Setup (0 Visual Changes)
**Duration:** 30 minutes
**Risk:** Low
**Goal:** Configure Tailwind without affecting existing styles

#### Tasks
- [x] Create todo list for migration tracking
- [ ] Configure `tailwind.config.js` with design tokens
- [ ] Add Tailwind to Vite config
- [ ] Create `src/tailwind.css` entry point
- [ ] Add `tw-` prefix to prevent conflicts during migration
- [ ] Validate: Site looks identical after setup
...
**Goal:** Build reusable Tailwind components for migration

#### 2.1 Button System (Fixes Report Issue #4)

**File:** `src/components/ui/Button.tsx`

**Design Decisions:**
- **Primary:** Orange background (`bg-amber`), white text - High-priority actions
- **Secondary:** White background, dark text - Standard actions
...
**File:** `src/components/ui/Paragraph.tsx`
