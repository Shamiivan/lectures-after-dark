        ...
        >
            <div className="container">
                ...
                <Element is="div" id="speakers-grid" canvas className={styles.speakersGrid}>
                    <SpeakerCard name="John Doe" topic="React"
                    image="https://images.unsplash.com/photo-1599566150163-29194d6f4675?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                    twitter="https://twitter.com/johndoe"
                    linkedin="https://linkedin.com/in/johndoe"
                    website="https://johndoe.com" />
                    <SpeakerCard name="Jane Doe" topic="Vue"
                    ...
                    <SpeakerCard name="Peter Jones" topic="Angular"
                    image="https://images.unsplash.com/photo-1597290282695-edc43d0e7129?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YmFyfGVufDB8fDB8fHww"
